...
const Hero = () => {
  return (
      ...
      <section className="flex flex-col custom-lg:flex-row  md:gap-[6.5rem] xl:flex-row py-12 px-12 md:py-24 md:px-20  bg-Neutral/Silver">
   ...
   <img className="w-full h-[25.438rem]" src="Illustration.svg"></img>
      </section>
